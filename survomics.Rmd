...
:::{.info-box .note}
- [Bioconductor](https://bioconductor.org/packages/release/bioc/html/TCGAbiolinks.html) might provide an old package version of **TCGAbiolinks** for Linux machines. 
Here, we use the version TCGAbiolinks_2.29.6. 
...
The following code implements the Bayesian Lasso Cox model with mandatory covariates through the `R` package [**psbcSpeedUp**](https://CRAN.R-project.org/package=psbcSpeedUp) [@Zhao2023].
